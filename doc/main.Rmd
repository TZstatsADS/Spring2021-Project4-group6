...
It does not require propensity score estimation and performs best with continuous variables.
...
#### Alternate Method that performs regression on each stratum by Y with A and Vs. Then averages the coefficients for A in each stratum to get the ATE.
