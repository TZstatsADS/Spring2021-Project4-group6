...
cat("\nATE for stratification alternative 2 is:", ATE_hd_alt2, ".\n")
#cat("Processing time for stratification is" , ?? , "seconds.\n")
cat("ATE error for stratification alternative 2 is:", true_high_ATE-ATE_hd_alt2, ".\n")
```
...
cat("\nATE for stratification alternative 2 is:", ATE_ld_alt2, ".\n")
#cat("Processing time for stratification is" , ?? , "seconds.\n")
cat("ATE error for stratification alternative 2 is:", true_low_ATE-ATE_ld_alt2, ".\n")
```
