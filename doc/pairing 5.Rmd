...
cat("Processing time of Linear Propensity Score estimation by Logistic Regression for low dimensional data is" ,linear.Propensity.Score.ate(lowDim_data)$running_time, "seconds", ".\n")
cat("Processing time of Linear Propensity Score estimation by Logistic Regression for high dimensional data is" ,linear.Propensity.Score.ate(highDim_data)$running_time, "seconds", ".\n")
